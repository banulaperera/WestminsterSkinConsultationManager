...
public class ConsultationGUI extends JFrame {
    ...
    ConsultationGUI(){
        ...
        forDate.setBounds(640, 460, 120, 35);
        forDate.setFont(new Font("MV Boli", Font.PLAIN,18));

        JLabel labelForDate = new JLabel();
        labelForDate.setBounds(790, 460, 150,35);
        ...
        calenderBtn2.setBounds(945, 460, 50,40);
        calenderBtn2.setIcon(new ImageIcon("calendar.png"));
        calenderBtn2.addActionListener(ae -> labelForDate.setText(new DatePicker(jFrame).setPickedDate()));

        JLabel labelForDuration = new JLabel("Duration(Hours)");
        labelForDuration.setBounds(1040, 460, 150,35);
...
//        JComboBox timeDuration = new JComboBox(hours);
        ...
        labelForNote.setBounds(640, 540, 100, 35);
        labelForNote.setFont(new Font("MV Boli", Font.PLAIN,18));

        JTextArea textAreaForNotes = new JTextArea();
        ...
        textAreaScroll.setBounds(790, 540, 200, 75);

        JLabel labelForImg = new JLabel("Upload an Image");
        labelForImg.setBounds(1040, 540, 170, 35);
        ...
        fileChooser.setBounds(1210,540, 150,35);
...
//        label.setIcon(new ImageIcon("ConsultationIcon.png"));
    ...
    private JComboBox ComboBox(){
        ...
        doctorList.setBounds(790, 373, 200,50);
